...
fn parse_seeds(numbers_str: &str) -> Vec<u64> {
...
mod tests {
    ...
    #[test]
    fn test_parse_seeds() {
        assert_eq!(parse_seeds("0 2"), vec![0, 1]);
        assert_eq!(parse_seeds("0 2 10 4"), vec![0, 1, 10, 11, 12, 13]);
    }
}
